...
@Component({
  ...
  template: `
    <div *ngIf="active" class="pointer-events-none fixed inset-0 z-50 overflow-hidden transition-opacity duration-300" [class.opacity-0]="!visible" [class.opacity-100]="visible">
      <div class="absolute inset-0 bg-gradient-to-br from-[#8A7CFF]/20 via-transparent to-[#E28FE8]/16 blur-2xl"></div>
