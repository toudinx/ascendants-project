# Combate & Balanceamento — Números (MVP) (SoT)

**Authority:** Source of Truth (números e tuning do MVP)  
**Status:** Ativo  
**Escopo:** Valores numéricos, tetos e régua. Regras do combate ficam no doc de combate.  
...
## 1) Constantes e caps (tuning)
- **DR_CAP (Redução de Dano % máxima aplicada): 90%**
- Rounding padrão em dano/cura: **floor**
- Fórmulas oficiais: ver `10_COMBATE_REGRAS.md`
...
- Crit Rate base: **5%**
- Crit DMG base: **150%** (multiplicador **1.5x**)
- Dano do Personagem % base: **0%**
- Redução de Dano % base: **0%**
- Heal % base: **0%**
- Energy Regen base: **100%** (multiplicador **1.0x**)
