...
- **Redução de Dano %** (mitiga dano de HP recebido)
- **Heal %** (aumenta cura gerada pela fonte)

> Fórmulas de aplicação: `10_COMBATE_REGRAS.md`  
> Valores/tetos: `11_COMBATE_NUMEROS_MVP.md`
...
- Definir sempre:
  ...
  - duração (em turnos)
  - empilha? (se não estiver definido, marcar TBD)

## Set **Agressão** (MVP)

- **3 peças:** +12% Dano do Personagem
- **5 peças:** Após usar a Habilidade Ativa, +25% Dano do Personagem por 2 turnos. **Não acumula.**
